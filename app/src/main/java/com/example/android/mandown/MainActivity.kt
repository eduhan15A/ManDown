...
class MainActivity : AppCompatActivity(), NavigationView.OnNavigationItemSelectedListener, SensorEventListener, SeekBar.OnSeekBarChangeListener {
            ...
            //    val sms = SmsManager.getDefault()
              //  sms.sendTextMessage(txbPhoneNumber.text.toString(), null, "help me", pi, null)
                ...
                if(!messageSent)
                {
                    ...
                    sendSMS(txbPhoneNumber.text.toString(), "Hi You got a message!");
